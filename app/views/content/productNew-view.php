...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Precio de elaboracion <?php echo CAMPO_OBLIGATORIO; ?></label>
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Tallas (separadas por coma)</label>
				  	<input class="input" type="text" name="producto_talla" placeholder="Ej: XS, S, M, L" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,255}" maxlength="255" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Corte o Modelo</label>
