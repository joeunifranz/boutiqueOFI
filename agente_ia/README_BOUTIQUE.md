...
- URL esperada por defecto: `http://127.0.0.1:5001/chat`
...
.\start_agente_ia.ps1 -Port 5001
```

## Probar el endpoint

```powershell
Invoke-RestMethod -Uri "http://127.0.0.1:5001/chat" -Method Post -ContentType "application/json" -Body (@{ message = "hola" } | ConvertTo-Json)
```
